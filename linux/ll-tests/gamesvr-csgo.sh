#!/bin/bash -i
declare LLCK_LOGFILE="/app/ll-tests/gamesvr-csgo.log";
declare LLCK_CMD="/app/srcds_run -game csgo +game_type 0 +game_mode 1 +map de_cache -insecure -tickrate 128 -norestart +sv_lan 1";
